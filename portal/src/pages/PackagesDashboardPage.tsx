      ...
      <header className="admin-header">
        <div>
          ...
          <p className="admin-desc">
            Обзор комплектов по организациям и периодам. Для повседневной работы
            используйте{" "}
            <Link to="/package">рабочее место «Комплекты»</Link>
            : список слева, карточка и формы справа.{" "}
            <strong>Заведено</strong> — сколько форм создано из каталога.{" "}
