    ...
    <div className="instructions-page">
      <header className="instructions-header">
        ...
        <p className="instructions-lead">
          Полное описание портала ОКО: назначение каждого раздела, порядок работы с формами,
          кнопки и ожидаемый результат. Для представителей организаций — вкладка ниже; для ЦО —
          дополнительно вкладка «Администратор».
        </p>
      </header>
